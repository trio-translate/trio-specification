...
Use these templates when expanding the specification. Replace placeholders, add concrete evidence, and remove sections that genuinely do not apply rather than filling them with vague text.

- [Situation](situation.md): people, context, outcome, main path, failures, and acceptance.
- [Condition](condition.md): reusable environmental changes, combined effects, state transitions, and recovery.
